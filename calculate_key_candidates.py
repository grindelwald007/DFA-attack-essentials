...
def calculate_key_candidates(ep_1, ep_2, ep_3, ep_4, f_Nr_A_0):
    ...
    # "e7" "51" "47" "99"
    set_1 = mo.compute_set(2, ep_1)
    set_2 = mo.compute_set(1, ep_2) 
    set_3 = mo.compute_set(1, ep_3)
    set_4 = mo.compute_set(3, ep_4)
    ...
    ep_1 = MatrixOperations.hex_to_binary_list(ep_1)
    res_1 = BinaryMatrix.custom_multiply(A_INV, np.array(ep_1).reshape(8, 1))
            
    res_1_int, _ = BinaryMatrix.bin_arr_to_hex(res_1)
            
    res_2 = gf_mult(c, res_1_int)
    # print(f"{c}.(a_1*{ep_1}) gmul : {hex(res_2)}")
